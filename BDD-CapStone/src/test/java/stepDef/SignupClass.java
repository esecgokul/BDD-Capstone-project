...
public class SignupClass {
	...
	public void SignUp() {
		...
		driver.findElement(By.name("email_id")).sendKeys("gokulakkannan@domain.com");
		driver.findElement(By.name("pwd")).sendKeys("gokulakkannan");
		driver.findElement(By.name("pwd2")).sendKeys("gokulakkannan");
		driver.findElement(By.name("name")).sendKeys("gokulakkannan");
